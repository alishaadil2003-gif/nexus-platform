            ...
            <div className="flex flex-wrap gap-2">
              {statuses.map(status => (
                <button
                  ...
                  className={`px-2 py-1 rounded-full text-xs font-medium cursor-pointer border ${selectedStatus.includes(status) ? 'bg-primary-100 text-primary-800 border-primary-300' : 'bg-gray-100 text-gray-600 border-gray-300'}`}
                >
                  {status}
                </button>
              ))}

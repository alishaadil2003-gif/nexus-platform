...
import { Home, Building2, CircleDollarSign, Users, MessageCircle, Bell, FileText, Settings, HelpCircle, Calendar, DollarSign } from 'lucide-react';

const SidebarItem: React.FC<{ to: string; icon: React.ReactNode; text: string }> = ({ to, icon, text }) => (
      ...
      <div className="h-full flex flex-col">
        ...
        <div className="p-4 border-t border-gray-200">
          <div className="bg-gray-50 rounded-md p-3">
            ...
            <a href="mailto:support@nexus.com" className="mt-2 inline-flex items-center text-xs font-medium text-primary-600 hover:text-primary-500">support@nexus.com</a>
          </div>
        </div>
      </div>
    </div>
